 ...
 * Purpose: Define Schema for Brand Library
 * Owner: Secondservice
...
export let brandMedia = new Schema({
...
BrandSchema.index({ "searchKeywords": 1, "name": 1 });

export let brands: Model<IBrand> = mongoose.model<IBrand>(config.DB_MODEL_REF.BRAND, BrandSchema);